...
class Vec256<float> {
 ...
 public:
  ...
  static std::enable_if_t<blendChoice(mask) == 0, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    return a;
  }

  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 1, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    return b;
  }

  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 2, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    return {b._vec0, a._vec1};
  }

  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 3, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    return {a._vec0, b._vec1};
  }

  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 4, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
  ...
  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 5, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    const __vib mask_1st = VsxMask1(mask);
  ...
  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 6, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
  ...
  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 7, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    const __vib mask_2nd = VsxMask2(mask);
    // generated masks
  ...
  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 8, Vec256<float>> __inline_attrs
  blend(const Vec256<float>& a, const Vec256<float>& b) {
    const __vib mask_1st = VsxMask1(mask);
    const __vib mask_2nd = VsxMask2(mask);
    return {
        (__vf)vec_sel(a._vec0, b._vec0, mask_1st),
