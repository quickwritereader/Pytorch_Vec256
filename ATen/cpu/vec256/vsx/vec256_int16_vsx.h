...
class Vec256<int16_t> {
 ...
 public:
  ...
  using vec_internal_mask_type = __vshb;
  static constexpr int size() {
    return 16;
  }
  Vec256() {}
  __inline_attrs Vec256(__vshi v) : _vec0{v}, _vec1{v} {}
  __inline_attrs Vec256(__vshb vmask) : _vecb0{vmask}, _vecb1{vmask} {}
  ...
  static std::enable_if_t<mask == 0, Vec256<int16_t>> __inline_attrs
  ...
  template <uint64_t mask>
  static std::enable_if_t<mask == 255, Vec256<int16_t>> __inline_attrs
  blend(const Vec256<int16_t>& a, const Vec256<int16_t>& b) {
  ...
  static std::enable_if_t<(mask > 0 && mask < 255), Vec256<int16_t>>
    ...
    return {(__vshi)vec_sel(a._vec0, b._vec0, (__vshb)mask_1st), a._vec1};
  }
  ...
  static std::enable_if_t<
    ...
    // generated masks
    return {b._vec0, (__vshi)vec_sel(a._vec1, b._vec1, (__vshb)mask_2nd)};
  }
  ...
  static std::enable_if_t<
    ...
    const __vshi mask_2nd =
        __vshi{g0_2, g1_2, g2_2, g3_2, g4_2, g5_2, g6_2, g7_2};
    // generated masks
    return {a, (__vshi)vec_sel(a._vec1, b._vec1, (__vshb)mask_2nd)};
  }
  ...
  static std::enable_if_t<
    ...
    // generated masks
    return {
        (__vshi)vec_sel(a._vec0, b._vec0, (__vshb)mask_1st),
