...
class Vec256<int64_t> {
 ...
 public:
  ...
  Vec256() {}
  __inline_attrs Vec256(__vlli v) : _vec0{v}, _vec1{v} {}
  ...
  static std::enable_if_t<mask == 0, Vec256<int64_t>> __inline_attrs
  blend(const Vec256<int64_t>& a, const Vec256<int64_t>& b) {
    return a;
  }

  template <uint64_t mask>
  static std::enable_if_t<mask == 3, Vec256<int64_t>> __inline_attrs
  blend(const Vec256<int64_t>& a, const Vec256<int64_t>& b) {
    return {b._vec0, a._vec1};
  }

  template <uint64_t mask>
  static std::enable_if_t<(mask & 15) == 15, Vec256<int64_t>> __inline_attrs
  blend(const Vec256<int64_t>& a, const Vec256<int64_t>& b) {
    return b;
  }

  template <uint64_t mask>
  static std::enable_if_t<(mask > 0 && mask < 3), Vec256<int64_t>> __inline_attrs
  blend(const Vec256<int64_t>& a, const Vec256<int64_t>& b) {
    ...
    return {(__vlli)vec_sel(a._vec0, b._vec0, (__vllb)mask_1st), a._vec1};
  }
  ...
  static std::enable_if_t<(mask > 3) && (mask & 3) == 0, Vec256<int64_t>>
    ...
    return {a._vec0, (__vlli)vec_sel(a._vec1, b._vec1, (__vllb)mask_2nd)};
  }
