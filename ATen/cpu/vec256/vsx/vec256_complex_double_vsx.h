...
class Vec256<ComplexDbl> {
 ...
 public:
  ...
  static Vec256<ComplexDbl> __inline_attrs elwise_blendv(
      const Vec256<ComplexDbl>& a,
      const Vec256<ComplexDbl>& b,
      const Vec256<ComplexDbl>& mask) {
    return {
  ...
  Vec256<ComplexDbl> el_mergeo() const {
    __vd v0 = vec_splat(_vec0, 1);
    __vd v1 = vec_splat(_vec1, 1);
    return {v0, v1};
  }
...
template <>
Vec256<ComplexDbl> inline clamp(
    const Vec256<ComplexDbl>& a,
...
template <>
Vec256<ComplexDbl> inline clamp_min(
    const Vec256<ComplexDbl>& a,
    const Vec256<ComplexDbl>& min) {
  auto abs_a = a.abs_2_();
  auto abs_min = min.abs_2_();
...
template <>
Vec256<ComplexDbl> inline clamp_max(
    const Vec256<ComplexDbl>& a,
    const Vec256<ComplexDbl>& max) {
  auto abs_a = a.abs_2_();
  auto abs_max = max.abs_2_();
